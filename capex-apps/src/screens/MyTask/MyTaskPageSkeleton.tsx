...
/** Dynamic zone only — kanban columns / mobile cards while tasks load. */
export const MyTaskContentSkeleton = memo(function MyTaskContentSkeleton() {
  return (
    <>
      <div className="hidden md:flex flex-1 gap-6 min-h-[320px] animate-pulse" aria-hidden>
      ...
      <div className="md:hidden space-y-4 animate-pulse" aria-hidden>
...
/** @deprecated Full-page skeleton — prefer static shell + MyTaskContentSkeleton. */
