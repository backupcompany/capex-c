...
const FormField: React.FC<{ label: string; icon: React.ReactNode; children: React.ReactNode; }> = ({ label, icon, children }) => {
    ...
    const control = kids.map((child, i) =>
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-6">
                    ...
                    <section>
                        ...
                        <div className="space-y-4">
                            ...
                            <FormField label="Budget Revenue Per Month" icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>}>
                    ...
                    <section>
                        ...
                        <div className="space-y-4">
                            <FormField label="Budget Category" icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" /></svg>}>
                               <select
                                   value={editedProject.budgetCategoryId ?? ''}
                                   onChange={e => handleInputChange('budgetCategoryId', e.target.value)}
                               ...
                               {isCreating ? (
                                   <p className="mt-1 text-xs text-siloam-text-secondary">
                                       Kategori dari langkah sebelumnya — bisa diganti di sini.
                                   </p>
                               ) : null}
                           </FormField>
