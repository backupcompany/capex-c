...
import { BootstrapModule } from '@capexbe/bootstrap/bootstrap.module';
import { ProjectListModule } from '@capexbe/project-list/project-list.module';
import { BudgetHuModule } from '@capexbe/budget-hu/budget-hu.module';
